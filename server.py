...
# Pure, Max-free patch-graph validators + the object database (docs.json), factored
# into patch_validators.py so patch_scoreboard.py can import them without the RAG
# stack (torch/chromadb/sentence-transformers). SINGLE SOURCE OF TRUTH — do not
# re-inline _validate_graph/_debug_graph/_resolve_object/flattened_docs here.
from patch_validators import (
    flattened_docs, _resolve_object, _KNOWN_UI_TYPES,
    _AUDIO_OUT_OBJS, _NO_WIRE_OK, _validate_graph, _debug_graph,
)
